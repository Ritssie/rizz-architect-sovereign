...
# ==============================================================================
st.set_page_config(
    page_title="Rizz Architect Sovereign v14.3", 
    page_icon="👑", 
    layout="wide",
...
st.markdown("""
    ...
    .sovereign-card { background: rgba(13, 17, 23, 0.9); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 20px; margin-bottom: 12px; }
    .winner-card { border: 1px solid rgba(252, 211, 77, 0.6); box-shadow: 0 10px 30px -10px rgba(252, 211, 77, 0.1); }
    .archetype-tag { font-family: 'JetBrains Mono', monospace; font-size: 0.6rem; color: #fcd34d; background: rgba(252, 211, 77, 0.1); padding: 3px 10px; border-radius: 4px; margin-bottom: 10px; display: inline-block; }
    ...
    .stButton>button { background: transparent !important; border: 1px solid rgba(255, 255, 255, 0.1) !important; color: white !important; font-family: 'JetBrains Mono' !important; font-size: 0.7rem !important; text-transform: uppercase !important; }
